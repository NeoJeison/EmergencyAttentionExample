...
public class AttentionServiceImp implements AttentionService {
	...
	public void createUsers()
	{
        ...
        medicine.setMedicineInventory(medicineInventoryRepository.findByMedicine(medicine));
        ...
        medicine2.setMedicineInventory(medicineInventoryRepository.findByMedicine(medicine2));
        ...
        medicine3.setMedicineInventory(medicineInventoryRepository.findByMedicine(medicine3));
